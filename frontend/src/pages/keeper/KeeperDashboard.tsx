  ...
  return (
    <div className="max-w-7xl mx-auto py-24 px-6">
      <div className="mb-12">
        ...
        <h1 className="text-5xl font-bold display text-navy">Keeper Dashboard</h1>
      </div>
      ...
      <div className="bg-white border border-dashed border-navy/10 rounded-[2.5rem] p-16 flex flex-col items-center justify-center text-center gap-6">
        <Truck size={48} className="text-navy/20" />
        <div>
        ...
        <p className="text-sm text-navy/40 max-w-sm leading-relaxed">
          This is a placeholder. The full keeper panel (active routes, pickup confirmations, delivery status) will be built here.
        </p>
        <Link
          to="/"
